...
```{r visualise, fig.height = 4.5, fig.cap = "The mixture-proxy log-density contours (orange, dashed) track the KDE's contours (blue, solid) closely across the sampled region.", fig.alt = "Contour plot comparing the KDE log-density and the Gaussian-mixture proxy log-density on a planar grid, with sample points overlaid."}
grid <- expand.grid(
...
The two contour sets nearly coincide: the four-component proxy reproduces
the KDE's log-density closely enough that the compression from a
kernel-density object to a closed-form mixture costs little accuracy here.
