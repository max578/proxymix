...
a single estimate would overstate what the data support. The appropriate summary is
a curve: `proxy_mnar_sensitivity()` sweeps the slope and reports the pooled mean
...
```{r tornado, echo = FALSE, fig.cap = "The pooled mean rises with the assumed sensitivity slope and crosses the complete-data truth (dashed line) near the slope that actually generated the data.", fig.alt = "Pooled mean of y against the assumed sensitivity slope, with confidence bands and the complete-data truth marked."}
